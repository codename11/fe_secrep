      ...
      <div>
        <Form onSubmit={this.handleSubmit} name="myForm">
            ...
            <Form.Group className="mb-1" controlId="formBasicRegistration">
                ...
                <Form.Control type="text" name="name" onChange={this.test} placeholder="Enter new name" defaultValue={vehicle.registration} />
            </Form.Group>
            ...
            <Button naame="button" variant="outline-warning" type="submit">
              Update
            </Button>
        </Form>
