...
function UpdateDelivery(props){
    ...
    const handleSubmit = (e) => {
      ...
      const data = {
        id: props && props.chosen_delivery && props.chosen_delivery.id ? props.chosen_delivery.id : null,
        operator_id: elements["employees"].value ? elements["employees"].value : null,
        vehicles: props.labelIds ? props.labelIds : null,
    ...
    let labelIds = props && props.labelIds ? props.labelIds : [];
    ...
    for(let i=0;i<=props.cnt;i++){
        ...
        <Form.Control id={"delivery_note"+i} key={i} placeholder="Enter new delivery note"  name={"delivery_note"+i} defaultValue={props && props.chosen_delivery && props.chosen_delivery.delivery_details && props.chosen_delivery.delivery_details[i] ? props.chosen_delivery.delivery_details[i].delivery_note : ""}/>
        </Form.Group>);
    ...
    let defaultLoadPlace = props && props.chosen_delivery && props.chosen_delivery.load_place ? props.chosen_delivery.load_place : ""; 
    let defaultUnLoadPlace = props && props.chosen_delivery && props.chosen_delivery.unload_place ? props.chosen_delivery.unload_place : ""; 
    let comment = props && props.chosen_delivery && props.chosen_delivery.comment ? props.chosen_delivery.comment : ""; 
    return (
