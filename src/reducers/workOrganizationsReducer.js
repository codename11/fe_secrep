import { LIST_WORK_ORGANIZATIONS, CREATE_WORK_ORGANIZATION, UPDATE_WORK_ORGANIZATION, DELETE_WORK_ORGANIZATION, LINKOVI, PAGINATION } from "../actions/types";
...
export default function(state = initialState, action){
    ...
    switch(action.type){
        ...
        case LIST_WORK_ORGANIZATIONS:
            //console.log("LIST_WORK_ORGANIZATIONS: ", action.payload);
        ...
        case PAGINATION:
            ...
            myState = {
                list_work_organizations: state.list_work_organizations,
